...
png('plot1.png')
hist(hpowerf$Global_active_power, xlab = "Global Active Power (kilowatts)", ylab = "Frequency", col = "red", main = "Global Active Power", xlim = c(0, 6), axes = FALSE)
axis(1, at = c(0, 2, 4, 6), labels = c("0", "2", "4", "6"), las = 0)
axis(2)
dev.off()
